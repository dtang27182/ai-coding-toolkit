...
- Ground every entry in Implementation Dataflow and the current code. If the representation exposes a design gap, update the HLD doc before continuing rather than expanding or revising the design only in the Architecture Diff.
